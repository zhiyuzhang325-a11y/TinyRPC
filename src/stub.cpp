...
AddServiceStub::AddServiceStub(int fd) : m_fd(fd) {}

AddResponse AddServiceStub::add(AddRequest req) {
    string request_data;
...
string AddServiceStub::call(const string &service_name, const string &handler_name, string request_data) {
